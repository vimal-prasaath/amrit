    ...
    data: [
      {
        ...
        content:
          "Dermatology is the branch of medicine dealing with the skin, hair, and nails. It encompasses a wide range of conditions that can affect these areas from common issues like acne and eczema to more severe diseases such as psoriasis and skin cancer. These conditions can significantly impact a person's quality of life, causing discomfort, pain, and emotional distress. At Amrit Hospital, our dermatology department specializes in diagnosing and treating these disorders using the latest technology and advanced treatments. Skin diseases can manifest in various forms including rashes, lesions, and chronic itching. Hair and nail disorders also fall under dermatology, with conditions such as alopecia (hair loss) and fungal infections being common. Whether it's a cosmetic concern or a severe medical issue, our expert dermatologists are equipped to provide comprehensive care, ensuring each patient receives the best possible treatment.",
        points: null,
      },
      {
        header: "Symptoms to Look Out For",
    ...
    data: [
      {
        ...
        content:
          "The Department of Diabetology at Amrit Hospital specializes in the comprehensive management of diabetes and related metabolic disorders. Our team of endocrinologists and diabetes specialists is dedicated to providing personalized care to help patients control their blood sugar levels and manage both Type 1 and Type 2 diabetes effectively. We focus on a multidisciplinary approach, integrating medication management, lifestyle modifications, and ongoing education to improve overall health outcomes. Diabetes can lead to various complications if not properly managed, including cardiovascular issues, nerve damage, and kidney problems. Our department offers advanced diagnostic tools and treatment options to address these risks, ensuring that each patient receives targeted care tailored to their specific needs. We also emphasize preventive measures to reduce the risk of long-term complications and enhance overall well-being.",
        points: null,
      },
      {
        header: "Symptoms to Look Out For",
    ...
    data: [
      {
        ...
        content:
          "The Department of ENT (Ear Nose and Throat) at Amrit Hospital provides comprehensive care for a variety of conditions affecting the auditory, nasal, and throat regions. Our skilled ENT specialists utilize state-of-the-art technology and treatments to address both common and complex issues. We focus on delivering personalized care with the aim of enhancing your quality of life through precise diagnosis and effective treatment. Our services cover a wide range of ENT conditions including hearing loss, sinusitis, throat infections, and allergies. We offer advanced procedures for conditions such as obstructive sleep apnea, nasal congestion, and tonsillitis, using minimally invasive techniques whenever possible. Our goal is to provide exceptional care that addresses your specific needs and improves overall health outcomes.",
        points: null,
      },
      {
        header: "Symptoms to Look Out For",
    ...
    data: [
      {
        ...
        content:
          "The Department of Nephrology at Amrit Hospital specializes in the diagnosis and treatment of kidney-related conditions, including chronic kidney disease, acute kidney injury, and kidney stones. Our team of nephrologists is equipped with state-of-the-art technology to provide comprehensive care, including dialysis and kidney transplant services. We focus on early detection and prevention of kidney disease, offering personalized treatment plans to manage and mitigate complications associated with renal disorders.",
        points: null,
      },
      {
        header: "Symptoms to Look Out For",
    ...
    data: [
      {
        ...
        content:
          "The Department of Gastroenterology at Amrit Hospital offers expert care for a wide range of digestive disorders. Our team of gastroenterologists specializes in the diagnosis and treatment of conditions affecting the gastrointestinal tract, liver, pancreas, and gallbladder. We provide advanced endoscopic procedures, including colonoscopy and gastroscopy, to diagnose and treat conditions such as acid reflux, irritable bowel syndrome, inflammatory bowel disease, and liver diseases. Our focus is on providing personalized care to improve digestive health and overall quality of life.",
        points: null,
      },
      {
        header: "Symptoms to Look Out For",
